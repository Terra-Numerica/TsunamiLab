(function (global, factory) {
    ...
    let Model = function(data, output){
        ...
        let defaultColormap = {    
            ...
            rgba: [[ 0, 0, 1,1],
                 [ 0, 31/255, 1,0.8 ],
                 [0, 61/255, 255/255,0.8 ],
                 [ 0, 102/255, 1,0.8 ],
                 [ 0, 128/255, 255/255,0.8 ],
                 [ 0, 159/255, 255/255, 0.9 ],
                 [ 0, 189/255, 255/255, 0.8 ],
                 [ 0, 225/255, 255/255, 0.4 ],
                 [ 0, 255/255, 255/255, 0 ],
                 [ 28/255, 227/255, 227/255, 0.4 ],
                 [ 74/255, 181/255, 181/255, 0.8 ],
                 [ 103/255, 152/255, 152/255, 0.9 ],
                 [ 143/255, 112/255, 112/255,0.8 ],
                 [ 170/255, 85/255, 85/255, 0.8 ],
                 [ 201/255, 54/255, 54/255, 0.8 ],
                 [255, 0, 0 ,1 ]]
        };
